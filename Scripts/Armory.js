...
Holy.prototype.update = function (du) {
	...
	if(this.height === null || this.width === null)
	{
		this.height = g_images.holy.height; //define the height of holy prototype
		this.width = g_images.holy.width; //define the width of holy prototype
	}
...
Grenade.prototype.update = function (du) {
	...
	if(this.height === null || this.width === null)
	{
		this.height = g_images.grenade.height; //define the height of grenade prototype
		this.width = g_images.grenade.width; //define the width of grenade prototype
	}
